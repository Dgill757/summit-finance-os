...
export default async function PlanningPage() {
  ...
  const [{ data: accounts }, { data: transactions }, { data: goals }, { data: manualAssets }, { data: snapshots }] = await Promise.all([
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <PlanningContent accounts={(accounts || []) as any} transactions={(transactions || []) as any} goals={(goals || []) as any} manualAssets={(manualAssets || []) as any} snapshots={(snapshots || []) as any} />
    </div>
  )
}
